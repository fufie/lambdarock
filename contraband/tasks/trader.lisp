...
(defmethod finish-quest ((variant contraband) (quest tepesco-quest-avi) quest-taker)
...
(defmethod finish-quest ((variant contraband) (quest tepesco-quest-avi-forms) quest-taker)
  (call-next-method)
  (remove-from-inventory quest-taker '(object "export-forms")))

(defmethod init-quest ((variant contraband) (quest tepesco-quest-avi-transport) quest-giver quest-taker)
  (call-next-method)
...
(defmethod finish-quest ((variant contraband) (quest tepesco-quest-avi-transport) quest-taker)
  (call-next-method)
  ;;(warn "Finish ~s" quest)
  ;;(warn "QG ~s, QT ~s, Q.G ~s, Q.T ~s" quest-giver quest-taker (quest.giver quest) (quest.taker quest))
