...
(fli:define-foreign-function (c-get-internal-time "lbui_get_internal_time")
    nil
    :result-type :unsigned :language :c 
    :calling-convention :stdcall :module :lang-ffi)

(fli:define-foreign-function (c-flip-framebuffer "lbui_flip_framebuffer")
    nil
    :result-type :int :language :c 
    :calling-convention :stdcall :module :lang-ffi)

(fli:define-foreign-function (c-get-idx-value "lbui_get_idx_value")
    ((idx :int))
    :result-type (:reference-pass :ef-mb-string) :language :c 
    :calling-convention :stdcall :module :lang-ffi)

(fli:define-foreign-function (c-set-idx-intvalue "lbui_set_idx_intvalue")
    ((idx :int) (value :int))
    :result-type :int :language :c 
    :calling-convention :stdcall :module :lang-ffi)

(fli:define-foreign-function (c-set-idx-stringvalue "lbui_set_idx_stringvalue")
    ((idx :int) (value (:reference-pass :ef-mb-string)))
    :result-type :int :language :c 
    :calling-convention :stdcall :module :lang-ffi)
