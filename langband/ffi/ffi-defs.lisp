...
(def-foreign-function ("lbui_get_internal_time" c-get-internal-time)
    :returns 'unsigned
    :args nil)

(def-foreign-function ("lbui_flip_framebuffer" c-flip-framebuffer)
    :returns 'int
    :args nil)

(def-foreign-function ("lbui_get_idx_value" c-get-idx-value)
    :args '((int idx))
    :returns 'cptr)

(def-foreign-function ("lbui_set_idx_intvalue" c-set-idx-intvalue)
    :args '((int idx)
	    (int value))
    :returns 'int)

(def-foreign-function ("lbui_set_idx_stringvalue" c-set-idx-stringvalue)
    :args '((int idx)
	    (cptr value))
    :returns 'int)
