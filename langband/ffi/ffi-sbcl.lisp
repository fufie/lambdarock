...
(sb-alien:define-alien-routine ("lbui_get_internal_time" c-get-internal-time)
           unsigned)


(declaim (inline c-flip-framebuffer))
(sb-alien:define-alien-routine ("lbui_flip_framebuffer" c-flip-framebuffer)
           int)


(declaim (inline c-get-idx-value))
(sb-alien:define-alien-routine ("lbui_get_idx_value" c-get-idx-value)
           cptr
           (idx int :in))


(declaim (inline c-set-idx-intvalue))
(sb-alien:define-alien-routine ("lbui_set_idx_intvalue" c-set-idx-intvalue)
           int
           (idx int :in)
           (value int :in))
...
(sb-alien:define-alien-routine ("lbui_set_idx_stringvalue" c-set-idx-stringvalue)
           int
           (idx int :in)
           (value cptr))
