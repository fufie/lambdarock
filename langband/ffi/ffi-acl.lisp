...
(ff:def-foreign-call (c-init-c-side& "lbui_init_c_side")
   ((source-path cptr) (config-path cptr) (data-path cptr) (win-width :int)
...
(ff:def-foreign-call (c-get-internal-time "lbui_get_internal_time")
   nil
   :returning :unsigned-long)

(ff:def-foreign-call (c-flip-framebuffer "lbui_flip_framebuffer")
   nil
   :returning :int)

(ff:def-foreign-call (c-get-idx-value "lbui_get_idx_value")
   ((idx :int))
   :returning cptr)

(ff:def-foreign-call (c-set-idx-intvalue "lbui_set_idx_intvalue")
   ((idx :int) (value :int))
   :returning :int)

(ff:def-foreign-call (c-set-idx-stringvalue "lbui_set_idx_stringvalue")
   ((idx :int) (value cptr))
   :returning :int)
