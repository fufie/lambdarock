...
the rest of the game is init'ed."
  ...
  ;;(cl:use-package :org.langband.dialogue :org.langband.contraband)
...
(defmethod activate-object :after ((var-obj contraband) &key)
  ...
  (register-level-builder! "town-level"
			   (get-late-bind-function 'org.langband.contraband
...
(defun con/init-eq-system (var-obj)
