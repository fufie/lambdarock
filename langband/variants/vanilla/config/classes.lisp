...
(define-character-class "warrior" "Warrior"
  ...
  :starting-equipment '((obj :id "broad-sword")
			...
			(obj :id "metal-cap" :ego "ego-helmet-beauty")
			(obj :id "small-metal-shield" :ego "ego-shield-elvenkind")
			#||
			(obj :id "lantern")
			...
			(obj :id "rod-polymorph")
			(obj :id "rod-illumination" :amount 3)
			(obj :id "scroll-mapping" :amount 9)
			#||
			(obj :id "ring-stupid")
