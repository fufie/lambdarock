...
(define-ego-item "ego-item-8" "of Resistance"
  ...
  :cost 12500
  :obj-types '(<hard-body-armour> <soft-body-armour>)
  :flags '((<ignore> <cold>) (<ignore> <fire>)
	   (<ignore> <electricity>) (<ignore> <acid>)
...
(define-ego-item "ego-item-11" "of Permanence"
  ...
  :flags '((<ignore> <cold>) (<ignore> <fire>)
	   ...
	   (<resist> <cold>) (<resist> <fire>)
           (<resist> <electricity>) (<resist> <acid>)
	   <hold-life> (<sustain> <chr>) (<sustain> <wis>)
	   (<sustain> <int>) (<sustain> <con>)
...
(define-ego-item "ego-shield-resistance" "of Resistance"
  :numeric-id 20
  :power-lvl 20
  :max-to-ac 10
  :locations '((0 . 2))
...
(define-ego-item "ego-shield-elvenkind" "of Elvenkind"
  :numeric-id 21
  :power-lvl 25
  :xtra 2
  :max-to-ac 10
  ...
  :cost 18000
  :obj-types '(<shield>)
  :flags '((<ignore> <electricity>) (<ignore> <cold>)
	   (<ignore> <fire>) (<ignore> <acid>)
	   (<resist> <electricity>) (<resist> <acid>)
...
(define-ego-item "ego-item-22" "of Preservation"
  ...
  :flags '((<ignore> <cold>) (<ignore> <fire>)
	   (<ignore> <electricity>) (<ignore> <acid>)
	   <hold-life> (<sustain> <dex>) (<sustain> <con>)
...
(define-ego-item "ego-helmet-wisdom" "of Wisdom"
  :numeric-id 25
  :power-lvl 13
  :pval 2
  :locations '((0 . 2))
...
(define-ego-item "ego-helmet-beauty" "of Beauty"
  :numeric-id 26
  :power-lvl 8
  :pval 4
  :locations '((0 . 2))
...
(define-ego-item "ego-item-46" "of Irritation"
  ...
  :locations '((0 . 1))
  :obj-types '(<cloak>)
  :flags '(<curse> <show-modifiers> <aggravate>))
...
(define-ego-item "ego-item-63" "of Annoyance"
  ...
  :locations '((0 . 10))
  :obj-types '(<boots>)
  :flags '(<hide-type> <curse> <aggravate> <stealth> <speed>))
...
(define-ego-item "ego-weapon-morgul" "of Morgul"
  :numeric-id 102
  :locations '((0 . 5))
  :cost 1
  :obj-types '(<sword> <pole-arm> <hafted>)
  :flags '((<brand> <poison>) (<slay> <undead>)
	   <drain-xp> <hold-life> <heavy-curse>
	   <aggravate> <see-invisible>))

(define-ego-item "ego-weapon-accuracy" "of Accuracy"
  :numeric-id 104
  :power-lvl 10
  :max-to-hit 15
  :max-to-dmg 5
...
(define-ego-item "ego-weapon-power" "of Power"
  :numeric-id 105
  :power-lvl 10
  :max-to-hit 5
  :max-to-dmg 15
...
(define-ego-item "ego-item-111" "of the Nazgul"
  ...
  :locations '((0 . 2))
  :obj-types '(<missile-weapon>)
  :flags '(<see-invisible> <drain-xp> <curse>))
