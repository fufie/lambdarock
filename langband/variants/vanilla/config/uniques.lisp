...
(define-monster-kind "dog-fang" "Fang"
  ...
  :numeric-id  47
  :gfx-sym (tile-paint-value 18 75)
...
(define-monster-kind "dog-grip" "Grip"
  :title "Farmer Maggot's dog"
  :numeric-id  46
  :gfx-sym (tile-paint-value 18 73)
  :desc "A rather vicious dog belonging to Farmer Maggot.  It thinks you are stealing mushrooms."
  :text-sym (text-paint-value +term-l-umber+ #\C)
  :type '(<animal> <unique>)
  :depth 2
...
(define-monster-kind "smeagol" "Smeagol"
  :numeric-id  52
  :gfx-sym (tile-paint-value 18 60)
...
(define-monster-kind "castamir" "Castamir"
  :title "the Usurper"
  :numeric-id  408
  :gfx-sym (tile-paint-value 24 35)
...
(define-monster-kind "elemental-vargo" "Vargo"
  ...
  :numeric-id  416
  :gfx-sym (tile-paint-value 24 36)
...
(define-monster-kind "elemental-waldern" "Waldern"
  :title "King of Water"
  :numeric-id  422
  :gfx-sym (tile-paint-value 24 37)
...
(define-monster-kind "dragon-kavlax" "Kavlax"
  ...
  :numeric-id  423
  :gfx-sym (tile-paint-value 24 38)
  ...
  :gender '<male>
  :resists '(<nexus> <gravity> <sound> <shards>)
...
(define-monster-kind "uvatha" "Uvatha"
  :title "the Horseman"
  :numeric-id  440
  :gfx-sym (tile-paint-value 24 39)
...
(define-monster-kind "medusa" "Medusa"
  :title "the Gorgon"
  :numeric-id  442
  :gfx-sym (tile-paint-value 24 40)
...
(define-monster-kind "ren" "Ren"
  :title "the Unclean"
  :numeric-id  457
  :gfx-sym (tile-paint-value 24 44)
...
(define-monster-kind "dawndeath" "Ji Indur Dawndeath"
  :numeric-id  464
  :gfx-sym (tile-paint-value 24 45)
...
(define-monster-kind "elemental-quaker" "Quaker"
  ...
  :numeric-id  466
  :gfx-sym (tile-paint-value 24 46)
...
(define-monster-kind "elemental-ariel" "Ariel"
  :title "Queen of Air"
  :numeric-id  468
  :gfx-sym (tile-paint-value 24 47)
...
(define-monster-kind "scatha" "Scatha"
  :title "the Worm"
  :numeric-id  473
  :gfx-sym (tile-paint-value 24 48)
...
(define-monster-kind "dwar" "Dwar"
  ...
  :numeric-id 474
  :gfx-sym (tile-paint-value 24 49)
...
(define-monster-kind "smaug" "Smaug"
  :title "the Golden"
  :numeric-id  475
  :gfx-sym (tile-paint-value 24 50)
...
(define-monster-kind "ulfast" "Ulfast"
  :title "son of Ulfang"
  :numeric-id  211
  :gfx-sym (tile-paint-value 24 10)
...
(define-monster-kind "dwarf-nar" "Nar"
  :title "the dwarf"
  :numeric-id  215
  :gfx-sym (tile-paint-value 24 11)
...
(define-monster-kind "orc-shagrat" "shagrat"
  ...
  :numeric-id  227
  :gfx-sym (tile-paint-value 24 12)
...
(define-monster-kind "orc-gorbag" "Gorbag"
  :title "the orc captain"
  :numeric-id  228
  :gfx-sym (tile-paint-value 24 13)
...
(define-monster-kind "orc-bolg" "Bolg"
  :title "son of Azog"
  :numeric-id  235
  :gfx-sym (tile-paint-value 24 14)
...
(define-monster-kind "orc-lugdush" "Lugdush"
  :title "the uruk"
  :numeric-id  249
  :gfx-sym (tile-paint-value 24 16)
...
(define-monster-kind "dwarf-ibun" "Ibun"
  :title "son of Mim"
  :numeric-id  268
  :gfx-sym (tile-paint-value 24 18)
...
(define-monster-kind "dwarf-khim" "Khim"
  :title "son of Mim"
  :numeric-id  269
  :gfx-sym (tile-paint-value 24 19)
...
(define-monster-kind "sangahyando" "Sangahyando"
  :title "of Umbar"
  :numeric-id  273
  :gfx-sym (tile-paint-value 24 20)
...
(define-monster-kind "angamaite" "Angamaite"
  :title "of Umbar"
  :numeric-id  274
  :gfx-sym (tile-paint-value 24 21)
...
(define-monster-kind "ulwarth" "Ulwarth"
  :title "son of Ulfang"
  :numeric-id  284
  :gfx-sym (tile-paint-value 24 22)
  :desc "A short and swarthy Easterling."
  :text-sym (text-paint-value +term-l-umber+ #\p)
  :alignment '<evil>
  :type '(<unique>)
...
(define-monster-kind "dwarf-mim" "Mim"
  ...
  :numeric-id  290
  :gfx-sym (tile-paint-value 24 23)
...
(define-monster-kind "ogre-lokkak" "Lokkak"
  ...
  :numeric-id  297
  :gfx-sym (tile-paint-value 24 24)
...
(define-monster-kind "uldor" "Uldor"
  :title "the accursed"
  :numeric-id  304
  :gfx-sym (tile-paint-value 24 25)
...
(define-monster-kind "imp-draebor" "Draebor"
  :title "the imp"
  :numeric-id  307
  :gfx-sym (tile-paint-value 24 26)
...
(define-monster-kind "shelob" "Shelob"
  ...
  :numeric-id  330
  :gfx-sym (tile-paint-value 24 27)
...
(define-monster-kind "troll-bert" "Bert"
  ...
  :numeric-id  343
  :gfx-sym (tile-paint-value 24 28)
...
(define-monster-kind "troll-bill" "Bill"
  :title "the stone troll"
  :numeric-id  344
  :gfx-sym (tile-paint-value 24 29)
...
(define-monster-kind "troll-tom" "Tom"
  :title "the stone troll"
  :numeric-id  345
  :gfx-sym (tile-paint-value 24 30)
...
(define-monster-kind "ulfang" "Ulfang"
  :title "the black"
  :numeric-id  355
  :gfx-sym (tile-paint-value 24 31)
...
(define-monster-kind "troll-rogrog" "Rogrog"
  ...
  :numeric-id  383
  :gfx-sym (tile-paint-value 24 32)
  ...
  :text-sym (text-paint-value +term-l-dark+ #\T)
  :alignment '<evil>
  :type '(<troll> <unique>)
  :depth 36
  :rarity 5
...
(define-monster-kind "lorgan" "Lorgan"
  ...
  :numeric-id  392
  :gfx-sym (tile-paint-value 24 33)
...
(define-monster-kind "ant-queen" "Formica"
  ...
  :numeric-id  395
  :gfx-sym (tile-paint-value 24 34)
...
(define-monster-kind "adunaphel" "Adunaphel"
  :title "the quiet"
  :numeric-id  449
  :gfx-sym (tile-paint-value 24 41)
...
(define-monster-kind "akhorahil" "Akhorahil"
  :title "the blind"
  :numeric-id  453
  :gfx-sym (tile-paint-value 24 42)
...
(define-monster-kind "gorlim" "Gorlim"
  ...
  :numeric-id  454
  :gfx-sym (tile-paint-value 24 43)
...
(define-monster-kind "dragon-itangast" "Itangast"
  ...
  :numeric-id  480
  :gfx-sym (tile-paint-value 24 51)
...
(define-monster-kind "dragon-glaurung" "Glaurung"
  ...
  :numeric-id  481
  :gfx-sym (tile-paint-value 24 52)
...
(define-monster-kind "balrog-muar" "Muar"
  :title "the balrog"
  :numeric-id  483
  :gfx-sym (tile-paint-value 24 53)
...
(define-monster-kind "minotaur-baphomet" "Baphomet"
  ...
  :numeric-id  490
  :gfx-sym (tile-paint-value 24 54)
...
(define-monster-kind "harowen" "Harowen"
  ...
  :numeric-id  491
  :gfx-sym (tile-paint-value 24 55)
...
(define-monster-kind "hoarmurath" "Hoarmurath"
  :title "of Dir"
  :numeric-id  492
  :gfx-sym (tile-paint-value 24 56)
...
(define-monster-kind "khamul" "Khamul"
  :title "the easterling"
  :numeric-id  494
  :gfx-sym (tile-paint-value 24 57)
...
(define-monster-kind "phoenix" "Phoenix"
  :numeric-id  497
  :gfx-sym (tile-paint-value 24 58)
...
(define-monster-kind "hydra-lernean" "Lernean hydra"
  :numeric-id  504
  :gfx-sym (tile-paint-value 24 59)
...
(define-monster-kind "vampire-thuringwethil" "Thuringwethil"
  :numeric-id  505
  :gfx-sym (tile-paint-value 24 60)
  ...
  :text-sym (text-paint-value +term-l-dark+ #\V)
  :alignment '<evil>
  :type '(<undead> <unique>)
  :depth 55
  :rarity 4
...
(define-monster-kind "dwarf-fundin" "Fundin Bluecloak"
  ...
  :text-sym (text-paint-value +term-l-green+ #\h)
  :type '(<unique>)
  :depth 56
  :rarity 2
  :hitpoints '(50 . 100)
...
(define-monster-kind "angel-uriel" "Uriel"
  :title "angel of fire"
  :numeric-id  509
  :gfx-sym (tile-paint-value 24 62)
...
(define-monster-kind "angel-azriel" "Azriel"
  ...
  :numeric-id  510
  :gfx-sym (tile-paint-value 24 63)
...
(define-monster-kind "dragon-ancalagon" "Ancalagon"
  :title "the black"
  :numeric-id  511
  :gfx-sym (tile-paint-value 24 64)
...
(define-monster-kind "angel-gabriel" "Gabriel"
  :title "the Messenger"
  :numeric-id  513
  :gfx-sym (tile-paint-value 24 65)
...
(define-monster-kind "saruman" "Saruman"
  ...
  :numeric-id  514
  :gfx-sym (tile-paint-value 24 66)
...
(define-monster-kind "cat-lord" "Cat Lord"
  ...
  :text-sym (text-paint-value +term-red+ #\f)
  :type '(<unique>)
  :depth 64
  :rarity 3
  :hitpoints '(48 . 100)
...
(define-monster-kind "tselakus" "Tselakus"
  :title "the Dreadlord"
  :numeric-id  522
  :gfx-sym (tile-paint-value 24 68)
...
(define-monster-kind "tiamat" "Tiamat"
  ...
  :numeric-id  523
  :gfx-sym (tile-paint-value 24 69)
...
(define-monster-kind "vecna" "Vecna"
  ...
  :numeric-id  528
  :gfx-sym (tile-paint-value 24 70)
  ...
  :text-sym (text-paint-value +term-l-red+ #\L)
  :alignment '<evil>
  :type '(<undead> <unique>)
  :depth 72
  :rarity 2
...
(define-monster-kind "omarax" "Omarax"
  ...
  :numeric-id  529
  :gfx-sym (tile-paint-value 24 71)
...
(define-monster-kind "spider-ungoliant" "Ungoliant"
  :title "the Unlight"
  :numeric-id  530
  :gfx-sym (tile-paint-value 24 72)
...
(define-monster-kind "mouth-sauron" "Mouth of Sauron"
  :numeric-id  532
  :gfx-sym (tile-paint-value 24 73)
...
(define-monster-kind "quylthulg-emperor" "Emperor quylthulg"
  :numeric-id  533
  :gfx-sym (tile-paint-value 24 74)
  ...
  :text-sym (text-paint-value +term-white+ #\Q)
  :alignment '<evil>
  :type '(<animal> <unique>)
  :depth 78
  :rarity 3
...
(define-monster-kind "qlzqqlzuup" "Qlzqqlzuup"
  ...
  :numeric-id  534
  :gfx-sym (tile-paint-value 24 75)
  ...
  :text-sym (text-paint-value +term-orange+ #\Q)
  :alignment '<evil>
  :type '(<animal> <unique>)
  :depth 78
  :rarity 3
...
(define-monster-kind "murazor" "Murazor"
  ...
  :numeric-id  535
  :gfx-sym (tile-paint-value 24 76)
...
(define-monster-kind "cantoras" "Cantoras"
  ...
  :numeric-id  538
  :gfx-sym (tile-paint-value 24 78)
...
(define-monster-kind "tarrasque" "Tarrasque"
  :numeric-id  539
  :gfx-sym (tile-paint-value 24 79)
  ...
  :text-sym (text-paint-value +term-violet+ #\R)
  :alignment '<evil>
  :type '(<unique>)
  :depth 84
  :rarity 2
...
(define-monster-kind "balrog-lungorthin" "Lungorthin"
  ...
  :numeric-id  540
  :gfx-sym (tile-paint-value 24 80)
  ...
  :text-sym (text-paint-value +term-white+ #\U)
  :alignment '<evil>
  :type '(<demon> <unique>)
  :depth 85
  :rarity 2
...
(define-monster-kind "wolf-draugluin" "Draugluin"
  ...
  :numeric-id  541
  :gfx-sym (tile-paint-value 24 81)
...
(define-monster-kind "feagwath" "Feagwath"
  ...
  :numeric-id  542
  :gfx-sym (tile-paint-value 24 82)
...
(define-monster-kind "wolf-carcharoth" "Carcharoth"
  ...
  :numeric-id  543
  :gfx-sym (tile-paint-value 24 83)
...
(define-monster-kind "cerberus" "Cerberus"
  ...
  :numeric-id  544
  :gfx-sym (tile-paint-value 24 84)
...
(define-monster-kind "balrog-gothmog" "Gothmog"
  ...
  :numeric-id  545
  :gfx-sym (tile-paint-value 24 85)
...
(define-monster-kind "sauron" "Sauron" ;; no title, he's sacry enough
  :numeric-id  546
  :gfx-sym (tile-paint-value 17 95)
...
(define-monster-kind "morgoth" "Morgoth"
  ...
  :numeric-id  547
  :gfx-sym (tile-paint-value 18 71)
