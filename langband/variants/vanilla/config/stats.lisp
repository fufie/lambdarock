...
(define-character-stat '<dex> "dexterity" :positive-desc "dextrous" :negative-desc "clumsy"
  :abbreviation "Dex" :number 1 :bit-flag #x02
  :data
...
(define-character-stat '<con> "constitution"
  :abbreviation "Con" :number 2 :bit-flag #x04
  :positive-desc "healthy" :negative-desc "sickly"
  :data
...
(define-character-stat '<int> "intelligence"
  :abbreviation "Int" :number 3 :bit-flag #x08
  :positive-desc "smart" :negative-desc "stupid"
  :data
...
(define-character-stat '<wis> "wisdom"
  :abbreviation "Wis" :number 4 :bit-flag #x10
  :positive-desc "wise" :negative-desc "naive"
  :data
...
(define-character-stat '<chr> "charisma"
  :abbreviation "Chr" :number 5 :bit-flag #x20
  :positive-desc "cute" :negative-desc "ugly"
  :data
  '((3 nil     :payment 130)
    (4 nil     :payment 125)
    (5 nil     :payment 122)
