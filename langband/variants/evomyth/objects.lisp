...
(defmethod initialise-objects& ((var-obj evomyth) &key old-file (file "objects"))
...
(defmethod write-obj-description ((variant evomyth) (obj active-object) stream
...
(defmethod initialise-object-kind! ((var-obj evomyth) (new-obj object-kind/armour) keyword-args)
...
(defmethod use-object! ((var evomyth) dungeon player the-object &key (which-use :use))
;;  (declare (ignore var))
